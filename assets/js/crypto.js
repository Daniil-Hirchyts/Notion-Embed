(() => {
    ...
    (() => {
        ...
        function i(t) {
            ...
            return {host: e.host, pathname: e.pathname, href: e.href}
        }
        ...
        const o = "__CUT__", a = "__FAIL__", c = "__NHTTP__", l = new RegExp("^http(s)?:(//)?"),
            h = ["hash", "search", "pathname"];

        function d(t, e = location.href) {
            const i = function (t) {
                try {
                    const e = new URL(t);
                    return l.test(e.protocol) ? null : c
                } catch (t) {
                    return a
                }
            }(e);
            if (i) return g(t, i), t;
            const r = new URL(e);
            if (g(t, r.toString())) return t;
            for (let e = 0; e < h.length; e++) {
                if (r[h[e]] = "", g(t, r.toString() + o)) return t;
                if (e === h.length - 1 && g(t, r.toString())) return t
            }
            return g(t, o), t
        }
        ...
        function g(t, e) {
            return function (t, e, i) {
                const r = new URL(t.toString());
                if (r.searchParams.set(e, i), 4096 < r.toString().length) return !1;
                return t.searchParams.set(e, i), !0
            }(t, "page-uri", e.replace(l, ""))
        }

        const p = ["locale", "symbol", "market"];
        const m = 767;
        var u, f, w;
        !function (t) {
        ...
        new class extends class {
            ...
            _getScriptsInfo() {
                const e = document.currentScript ? document.currentScript.src : null;
                if (!e) return console.error("Could not self-replace the script, widget embedding has been aborted"), [];
                const {host: r, href: n} = i(e), s = document.getElementsByTagName("script"), o = [];
                for (let t = 0; t < s.length; t++) {
                    const e = s.item(t);
                    e.src && i(e.src).href === n && o.push(e)
                }
                const a = t(r);
                return o.map((t => ({scriptHost: r, scriptEnv: a, scriptElement: t})))
            }

            _replaceScript(t) {
                const {scriptEnv: i, scriptHost: r, scriptElement: n} = t;
                this.script = n;
                const o = this._scriptContentToJSON(), a = function (t) {
                    if (null === t) return null;
                    const e = t.querySelector("#tradingview-copyright"), i = t.querySelector("#tradingview-quotes"),
                        r = e || i;
                    return r && t.removeChild(r), r
                }(this.script.parentNode), c = !!this.script.parentNode.querySelector(".tradingview-widget-copyright");
                ...
                const l = "32px", h = isNaN(this.settings.height) ? this.settings.height : this.settings.height + "px",
                ...
                ;this.script.parentNode && g ? this.iframeContainer = this.script.parentNode : this.iframeContainer = document.createElement("div"), this.iframeContainer.style.width = d, this.iframeContainer.style.height = h, this.iframeContainer.appendChild(function () {
                ...
                const p = a && !this.settings.whitelabel, m = this.hasCopyright ? `calc(${h} - 32px)` : h;
                this.settings.utm_source = location.hostname, this.settings.utm_medium = c ? "widget_new" : "widget", this.settings.utm_campaign = this.widgetUtmName, this.iframe = this._createIframe(m, d, r, i, n.id);
                ...
                if (u ? (this.script.parentNode.replaceChild(this.iframe, u), this.script.parentNode.removeChild(this.script)) : g ? (this.iframeContainer.appendChild(this.iframe), this.script.parentNode.removeChild(this.script)) : (this.iframeContainer.appendChild(this.iframe), this.script.parentNode.replaceChild(this.iframeContainer, this.script)), function (t, e, i) {
                    ...
                    t.style.height = l, t.style.lineHeight = l, t.style.width = d, t.style.textAlign = "center", t.style.verticalAlign = "middle", t.innerHTML = a.innerHTML, this.iframeContainer.appendChild(t)
                }
            }
            ...
            _setSettingsQueryString(t) {
                const e = this.propertiesToAddToGetParams.filter((t => -1 !== p.indexOf(t))), i = function (t, e) {
            ...
            _createIframe(t, e, i, r, n) {
                ...
                const o = new URL(this._iframeSrcBase(i, r));
                return o.hash = this._buildSettingsHashString(n), this._setSettingsQueryString(o), this.useParamsForConnectSocket && d(o), s.setAttribute("src", o.toString()), s
            }
        } {
            get widgetId() {
                return "ticker-tape"
            ...
            filterRawSettings(t) {
                ...
                try {
                    ...
                    e.height = function (t, e, i, r) {
                        let n = (s = t === u.Adaptive && r ? r <= y : t === u.Compact, s ? 72 : 44);
                        var s;
